...
If there is a previous installation of Rapier, it is best to delete it first than to overwrite the files if installing manually.
Once installed it is also recommended to reset the skin settings by going to System->Skin Settings->Reset Skin.
You may also want to delete the textures.db file that resides in userdata->database of your XBMC profile directory.
Doing these steps will prevent any unforeseen problems that may pop up.

The recommended way to install Rapier is to launch XBMC, then go into the add-ons node and choose "Install from zip file" and select the zip file.
This way it will automatically install any script dependencies which this skin requires for full functionality.

Manual installation can be done by moving the skin.rapier folder inside the zip into your addons folder of your XBMC profile.
...
Please note not all portions of this skin fall under the same license.
...
With the understanding that:
    ...
    Notice — For any reuse or distribution, you must make clear to others the license terms of this work. The best way to do that is with a link to http://creativecommons.org/licenses/by-nc-sa/3.0/ 
...
- Home window icons are created by Arcanthur of the XBMC community
- Studio icons are compiled by ccMatrix | https://github.com/ccMatrix/StudioLogos | The copyright of the logos are owned by the respective studios and these images are used in a form according to copyright and fair use laws
- Home music background is the work "turntable" by Troy McCullough | http://www.flickr.com/people/idletype/
- Home videos background is an adaptation of the work "Chinon 8mm Movie Camera" by SPDP | http://www.flickr.com/people/10068173@N08/ | http://creativecommons.org/licenses/by/2.0/deed.en
- Home movies background is the work "Ladies and gentlemen, please take your seats" by Paul Hart | http://www.flickr.com/people/atomicjeep/ | http://creativecommons.org/licenses/by/2.0/deed.en
- Home tv shows background is an adaptation of the work "LG PDP TV(PS8000)" by LGEPR | http://www.flickr.com/people/lge/ | http://creativecommons.org/licenses/by/2.0/deed.en
- Home programs background is provided by the XBMC community
- Home pictures background is an adaptation of the work "NIGHT FLOWER" by Jonas Seaman | http://www.flickr.com/people/americanvirus/ | http://creativecommons.org/licenses/by-nc-sa/2.0/deed.en
- Home general background is an adaptation of the work "60:365 Spiral and curves" by Jin Choi | http://www.flickr.com/people/openuser/ | http://creativecommons.org/licenses/by-sa/2.0/deed.en
- Home system background is an adaptation of the work "Backbone #2" by Andreas H | http://www.flickr.com/people/andih/
...
- GUI font is a derivative of the font "DejaVu Sans" under public domain | http://dejavu-fonts.org/wiki/Main_Page | Full License file can be found in fonts folder
